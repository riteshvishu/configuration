...
package extensions.pc.internal.domain.geodata.zone.gen;

import com.guidewire.pl.domain.geodata.zone.impl.AddressAutofillableImpl;
...
import gw.pl.geodata.zone.entity.AddressAutofillable;

public class AddressAutofillableExtStub
    extends AddressAutofillableImpl
    implements GlobalAddressExtInternal
{


    protected AddressAutofillableExtStub(AddressAutofillable owner) {
        super(owner);
    }
