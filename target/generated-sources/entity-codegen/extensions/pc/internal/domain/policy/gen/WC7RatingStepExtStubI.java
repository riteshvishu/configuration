...
import extensions.pc.policy.entity.WC7RatingStepExt;
...
public interface WC7RatingStepExtStubI
    extends KeyableBean
{

    EntityIntrinsicTypeReference<WC7RatingStepExt> TYPE = new EntityIntrinsicTypeReference<WC7RatingStepExt>("entity.WC7RatingStepExt");
     ...
     * 
     */
    WC7JurisdictionCostType getAggCostType();

    /**
     * Sets the value of the aggCostType field.
     * 
     */
    void setAggCostType(WC7JurisdictionCostType value);
