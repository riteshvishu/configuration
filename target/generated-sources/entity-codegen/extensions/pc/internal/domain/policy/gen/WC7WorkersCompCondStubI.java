...
public interface WC7WorkersCompCondStubI
    extends SubtypeBean, EffDatedCopyable, EffDatedLogicalMatcher, PolicyCondition, EffDated
{

    EffDatedEntityIntrinsicTypeReference<extensions.pc.policy.entity.WC7WorkersCompCond, PolicyPeriod> TYPE = new EffDatedEntityIntrinsicTypeReference<extensions.pc.policy.entity.WC7WorkersCompCond, PolicyPeriod>("entity.WC7WorkersCompCond");
     ...
     * 
     */
    extensions.pc.policy.typekey.WC7WorkersCompCond getSubtype();
    ...
    extensions.pc.policy.entity.WC7WorkersCompCond getBasedOn();

    extensions.pc.policy.entity.WC7WorkersCompCond getSlice(Date sliceDate);

    extensions.pc.policy.entity.WC7WorkersCompCond getUnsliced();

    PolicyPeriod getBranch();

    extensions.pc.policy.entity.WC7WorkersCompCond split(Date splitDate);

    extensions.pc.policy.entity.WC7WorkersCompCond clone();
