...
public abstract class WCRatingStepExtStub
    extends AbstractKeyableBeanProxy
    implements WCRatingStepExtInternalStubI
{
    ...
    @Override
    public WCJurisdictionCostType getAggCostType() {
        return ((WCJurisdictionCostType) getFieldValue(AGGCOSTTYPE_PROP.get()));
    }

    @Override
    public void setAggCostType(WCJurisdictionCostType value) {
