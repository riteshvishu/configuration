...
public abstract class WC7JurisdictionCovStub
    extends EffDatedBeanProxy
    implements WC7JurisdictionCovInternalStubI
{


    @Override
    public extensions.pc.policy.typekey.WC7JurisdictionCov getSubtype() {
        return ((extensions.pc.policy.typekey.WC7JurisdictionCov) getFieldValue(SUBTYPE_PROP.get()));
    }

    @Override
    public void setSubtype(extensions.pc.policy.typekey.WC7JurisdictionCov value) {
    ...
    @Override
    public String getChoiceTerm5() {
        return ((String) getFieldValueForCodegen(CHOICETERM5_PROP.get()));
    }

    @Override
    public void setChoiceTerm5(String value) {
        setFieldValueForCodegen(CHOICETERM5_PROP.get(), value);
    }

    @Override
    public Boolean isChoiceTerm5Avl() {
        return ((Boolean) getFieldValue(CHOICETERM5AVL_PROP.get()));
    }

    @Override
    public void setChoiceTerm5Avl(Boolean value) {
        setFieldValue(CHOICETERM5AVL_PROP.get(), value);
    }

    @Override
    public String getChoiceTerm6() {
        return ((String) getFieldValueForCodegen(CHOICETERM6_PROP.get()));
    }

    @Override
    public void setChoiceTerm6(String value) {
        setFieldValueForCodegen(CHOICETERM6_PROP.get(), value);
    }

    @Override
    public Boolean isChoiceTerm6Avl() {
        return ((Boolean) getFieldValue(CHOICETERM6AVL_PROP.get()));
    }

    @Override
    public void setChoiceTerm6Avl(Boolean value) {
        setFieldValue(CHOICETERM6AVL_PROP.get(), value);
    }
    ...
    @Override
    public WC7JurisdictionCovCost[] getCosts() {
        return ((WC7JurisdictionCovCost[]) getFieldValue(COSTS_PROP.get()));
    }

    @Override
    public void addToCosts(WC7JurisdictionCovCost value) {
        addArrayElement(COSTS_PROP.get(), value);
    }

    @Override
    public void removeFromCosts(WC7JurisdictionCovCost value) {
        removeArrayElement(COSTS_PROP.get(), value);
    }

    @Override
    public extensions.pc.policy.entity.WC7JurisdictionCov getBasedOn() {
        return ((extensions.pc.policy.entity.WC7JurisdictionCov) getBasedOnUntyped());
    }

    @Override
    public extensions.pc.policy.entity.WC7JurisdictionCov getSlice(Date sliceDate) {
        return ((extensions.pc.policy.entity.WC7JurisdictionCov) getSliceUntyped(sliceDate));
    }

    @Override
    public extensions.pc.policy.entity.WC7JurisdictionCov getUnsliced() {
        return ((extensions.pc.policy.entity.WC7JurisdictionCov) getUnslicedUntyped());
    }
    ...
    @Override
    public extensions.pc.policy.entity.WC7JurisdictionCov split(Date splitDate) {
        return ((extensions.pc.policy.entity.WC7JurisdictionCov) splitUntyped(splitDate));
    }

    @Override
    public extensions.pc.policy.entity.WC7JurisdictionCov clone() {
        return ((extensions.pc.policy.entity.WC7JurisdictionCov) cloneUntyped());
    }
