...
public abstract class RateGLClassCodeExtStub
    extends AbstractKeyableBeanProxy
    implements RateGLClassCodeExtInternalStubI
{
    ...
    public String getSubline() {
        return ((String) getFieldValueForCodegen(SUBLINE_PROP.get()));
    }

    @Override
    public void setSubline(String value) {
        setFieldValueForCodegen(SUBLINE_PROP.get(), value);
    }

    @Override
    public String getSplitType() {
        return ((String) getFieldValueForCodegen(SPLITTYPE_PROP.get()));
    }

    @Override
    public void setSplitType(String value) {
        setFieldValueForCodegen(SPLITTYPE_PROP.get(), value);
    }
