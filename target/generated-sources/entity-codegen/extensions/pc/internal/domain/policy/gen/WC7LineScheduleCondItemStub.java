...
public abstract class WC7LineScheduleCondItemStub
    extends EffDatedBeanProxy
    implements WC7LineScheduleCondItemInternalStubI
{


    @Override
    public extensions.pc.policy.typekey.WC7LineScheduleCondItem getSubtype() {
        return ((extensions.pc.policy.typekey.WC7LineScheduleCondItem) getFieldValue(SUBTYPE_PROP.get()));
    }

    @Override
    public void setSubtype(extensions.pc.policy.typekey.WC7LineScheduleCondItem value) {
        setFieldValue(SUBTYPE_PROP.get(), value);
    }

    @Override
    public WC7LineScheduleCond getSchedule() {
        return ((WC7LineScheduleCond) getFieldValue(SCHEDULE_PROP.get()));
    }

    @Override
    public void setSchedule(WC7LineScheduleCond value) {
    ...
    @Override
    public extensions.pc.policy.entity.WC7LineScheduleCondItem getBasedOn() {
        return ((extensions.pc.policy.entity.WC7LineScheduleCondItem) getBasedOnUntyped());
    }

    @Override
    public extensions.pc.policy.entity.WC7LineScheduleCondItem getSlice(Date sliceDate) {
        return ((extensions.pc.policy.entity.WC7LineScheduleCondItem) getSliceUntyped(sliceDate));
    }

    @Override
    public extensions.pc.policy.entity.WC7LineScheduleCondItem getUnsliced() {
        return ((extensions.pc.policy.entity.WC7LineScheduleCondItem) getUnslicedUntyped());
    }
    ...
    @Override
    public extensions.pc.policy.entity.WC7LineScheduleCondItem split(Date splitDate) {
        return ((extensions.pc.policy.entity.WC7LineScheduleCondItem) splitUntyped(splitDate));
    }

    @Override
    public extensions.pc.policy.entity.WC7LineScheduleCondItem clone() {
        return ((extensions.pc.policy.entity.WC7LineScheduleCondItem) cloneUntyped());
    }
    ...
    public String getStringCol3() {
        return ((WC7ScheduledItemInternal) getEntityDelegate(WC7ScheduledItem.class)).getStringCol3();
    }

    @Override
    public void setStringCol3(String value) {
        ((WC7ScheduledItemInternal) getEntityDelegate(WC7ScheduledItem.class)).setStringCol3(value);
    }

    @Override
    public String getStringCol4() {
        return ((WC7ScheduledItemInternal) getEntityDelegate(WC7ScheduledItem.class)).getStringCol4();
    }

    @Override
    public void setStringCol4(String value) {
        ((WC7ScheduledItemInternal) getEntityDelegate(WC7ScheduledItem.class)).setStringCol4(value);
    }

    @Override
    public Integer getIntCol2() {
        return ((WC7ScheduledItemInternal) getEntityDelegate(WC7ScheduledItem.class)).getIntCol2();
    }

    @Override
    public void setIntCol2(Integer value) {
        ((WC7ScheduledItemInternal) getEntityDelegate(WC7ScheduledItem.class)).setIntCol2(value);
    }
