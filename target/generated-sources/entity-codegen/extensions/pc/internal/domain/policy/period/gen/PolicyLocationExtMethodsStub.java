...
public abstract class PolicyLocationExtMethodsStub
    extends AspectBase
    implements PolicyLocationExtInternalMethodsStubI
{


    protected PolicyLocationExtMethodsStub(PolicyLocation owner) {
        super(((BeanProxy) owner));
    }

    @Override
    public PolicyLocation getOwner() {
        return ((PolicyLocation) super.getOwner());
    }
