...
public abstract class WC7LineScheduleExclItemStub
    extends EffDatedBeanProxy
    implements WC7LineScheduleExclItemInternalStubI
{


    @Override
    public extensions.pc.policy.typekey.WC7LineScheduleExclItem getSubtype() {
        return ((extensions.pc.policy.typekey.WC7LineScheduleExclItem) getFieldValue(SUBTYPE_PROP.get()));
    }

    @Override
    public void setSubtype(extensions.pc.policy.typekey.WC7LineScheduleExclItem value) {
        setFieldValue(SUBTYPE_PROP.get(), value);
    }

    @Override
    public WC7LineScheduleExcl getSchedule() {
        return ((WC7LineScheduleExcl) getFieldValue(SCHEDULE_PROP.get()));
    }

    @Override
    public void setSchedule(WC7LineScheduleExcl value) {
    ...
    @Override
    public extensions.pc.policy.entity.WC7LineScheduleExclItem getBasedOn() {
        return ((extensions.pc.policy.entity.WC7LineScheduleExclItem) getBasedOnUntyped());
    }

    @Override
    public extensions.pc.policy.entity.WC7LineScheduleExclItem getSlice(Date sliceDate) {
        return ((extensions.pc.policy.entity.WC7LineScheduleExclItem) getSliceUntyped(sliceDate));
    }

    @Override
    public extensions.pc.policy.entity.WC7LineScheduleExclItem getUnsliced() {
        return ((extensions.pc.policy.entity.WC7LineScheduleExclItem) getUnslicedUntyped());
    }
    ...
    @Override
    public extensions.pc.policy.entity.WC7LineScheduleExclItem split(Date splitDate) {
        return ((extensions.pc.policy.entity.WC7LineScheduleExclItem) splitUntyped(splitDate));
    }

    @Override
    public extensions.pc.policy.entity.WC7LineScheduleExclItem clone() {
        return ((extensions.pc.policy.entity.WC7LineScheduleExclItem) cloneUntyped());
    }
