...
import extensions.pc.policy.entity.RateWCClassCodeExt;
import gw.pl.persistence.core.entity.KeyableBean;

public interface RateWCClassCodeExtStubI
    extends KeyableBean
{

    EntityIntrinsicTypeReference<RateWCClassCodeExt> TYPE = new EntityIntrinsicTypeReference<RateWCClassCodeExt>("entity.RateWCClassCodeExt");
