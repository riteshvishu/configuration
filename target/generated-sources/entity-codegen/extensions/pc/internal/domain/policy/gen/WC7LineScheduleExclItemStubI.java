...
public interface WC7LineScheduleExclItemStubI
    extends SubtypeBean, WC7ScheduledItem, Coverable, ScheduledItem, EffDated
{

    EffDatedEntityIntrinsicTypeReference<extensions.pc.policy.entity.WC7LineScheduleExclItem, PolicyPeriod> TYPE = new EffDatedEntityIntrinsicTypeReference<extensions.pc.policy.entity.WC7LineScheduleExclItem, PolicyPeriod>("entity.WC7LineScheduleExclItem");
     ...
     * 
     */
    extensions.pc.policy.typekey.WC7LineScheduleExclItem getSubtype();
     ...
     * 
     */
    WC7LineScheduleExcl getSchedule();

    /**
     * Sets the value of the Schedule field.
     * 
     */
    void setSchedule(WC7LineScheduleExcl value);

    extensions.pc.policy.entity.WC7LineScheduleExclItem getBasedOn();

    extensions.pc.policy.entity.WC7LineScheduleExclItem getSlice(Date sliceDate);

    extensions.pc.policy.entity.WC7LineScheduleExclItem getUnsliced();

    PolicyPeriod getBranch();

    extensions.pc.policy.entity.WC7LineScheduleExclItem split(Date splitDate);

    extensions.pc.policy.entity.WC7LineScheduleExclItem clone();
