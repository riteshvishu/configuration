...
class PolicyPeriodAPI {
  ...
  function addNoteToPolicyPeriod(policyPeriodId : String,
    ...
    Transaction.runWithNewBundle(\ bundle -> {
      ...
      if (policyPeriod.Archived) {
        throw new BadIdentifierException("Could not add note to policy period ${policyPeriod} because it is archived")
      }
  ...
  function addDocumentToPolicyPeriod(policyPeriodId : String,
    ...
    Transaction.runWithNewBundle(\ bundle -> {
      ...
      if (policyPeriod.Archived) {
        throw new BadIdentifierException("Could not add document to policy period ${policyPeriod} because it is archived")
      }
