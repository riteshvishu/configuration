...
class IMaintenanceToolsAPI {
   ...
   *
   * @return An array of {@link com.guidewire.pc.webservices.entity.UpdateTableStatisticsData} items, one for each table that has
  ...
  private function getMaintenanceImpl() : IPCMaintenanceToolsAPI {
