...
class ContactAPI implements ABClientAPI {
  ...
  function removeContactByPublicID(contactPublicId : String) : String {
    ...
    Transaction.runWithNewBundle(\ bundle -> {
      SOAPUtil.convertToSOAPException(PCLoggerCategory.CONTACT_API, \ -> {
        ...
        // find the Contact
        var contact = bundle.loadByPublicId(Contact, contactPublicId) as Contact
        if (contact == null) {
  ...
  function mergeContactAddressesByPublicId(contactPublicId : String, survivingAddressPublicId : String, mergedAddressPublicId : String) : String {
    ...
    Transaction.runWithNewBundle(\ bundle -> {
      var contactToMergeOn = bundle.loadByPublicId(Contact, contactPublicId) as Contact
      survivingAddress = bundle.loadByPublicId(Address, survivingAddressPublicId) as Address
      var mergedAddress = bundle.loadByPublicId(Address, mergedAddressPublicId) as Address
    ...
    try {
      Transaction.runWithNewBundle(\ bundle -> {
        ...
        if (keptContact == null and deletedContact == null) {
          ...
          // This is a no-op, nothing to do we don't have the contact they are asking us to merge
        } else {
  ...
  function mergeContactsByPublicId(keptContactPubId : String, deletedContactPubId : String) : String {
    ...
    var keptContact : Contact
    Transaction.runWithNewBundle(\ bundle -> {
      keptContact = bundle.loadByPublicId(Contact, keptContactPubId) as Contact
      var deletedContact = bundle.loadByPublicId(Contact, deletedContactPubId) as Contact
