...
enhancement GLExposureEnhancement : entity.GLExposure {
  ...
  property set LocationWM(_location: PolicyLocation)  {
    this.asssertWindowMode(_location)
  ...
  function firstMatchingClassCode(code : String) : GLClassCode {
    ...
    var effectiveDate = this.GLLine.getReferenceDateForCurrentJob(JurisdictionMappingUtil.getJurisdictionMappingForPolicyLocation(this.LocationWM ))
