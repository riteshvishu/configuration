...
class IMARCoverableAdapter implements CoverableAdapter {
  ...
  override property get State() : Jurisdiction  {
    return JurisdictionMappingUtil.getJurisdictionMappingForPolicyLocation(_owner.IMBuilding.Building.PolicyLocation )
  }
  ...
  override property get AllowedCurrencies() : List<Currency> {
    return PolicyLineConfiguration.get(InstalledPolicyLine.TC_IM).AllowedCurrencies
  }
}