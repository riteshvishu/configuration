...
class PersonalVehicleCoverableAdapter implements CoverableAdapter {
  ...
  override property get State() : Jurisdiction{
    ...
    if(_owner.GarageLocation != null){
      retVal = JurisdictionMappingUtil.getJurisdictionMappingForPolicyLocation(_owner.GarageLocation )
    }
    return retVal
  }
  ...
  override property get AllowedCurrencies() : List<Currency> {
    return PolicyLineConfiguration.get(InstalledPolicyLine.TC_PA).AllowedCurrencies
  }
}
