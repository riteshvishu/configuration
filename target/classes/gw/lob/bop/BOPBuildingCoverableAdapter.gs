...
class BOPBuildingCoverableAdapter implements CoverableAdapter {
  ...
  override property get State() : Jurisdiction{
    return JurisdictionMappingUtil.getJurisdictionMappingForPolicyLocation(_owner.BOPLocation.Location )
  }
  ...
  override function addCoverage( p0: Coverage ) : void {
    _owner.addToCoverages( p0 as BOPBuildingCov )
  }

  override function removeCoverage( p0: Coverage ) : void {
    _owner.removeFromCoverages( p0 as BOPBuildingCov )
  }
  ...
  override property get AllowedCurrencies() : List<Currency> {
    return PolicyLineConfiguration.get(InstalledPolicyLine.TC_BOP).AllowedCurrencies
  }
}
