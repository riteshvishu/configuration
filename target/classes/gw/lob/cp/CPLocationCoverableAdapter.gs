...
class CPLocationCoverableAdapter implements CoverableAdapter {
  ...
  override property get State() : Jurisdiction {
    return JurisdictionMappingUtil.getJurisdictionMappingForPolicyLocation(_owner.Location )
  }
  ...
  override property get AllowedCurrencies() : List<Currency> {
    return PolicyLineConfiguration.get(InstalledPolicyLine.TC_CP).AllowedCurrencies
  }
}