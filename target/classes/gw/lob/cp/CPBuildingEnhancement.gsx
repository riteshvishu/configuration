...
enhancement CPBuildingEnhancement : CPBuilding {
  ...
  function firstMatchingClassCode(code : String) : CPClassCode {
    ...
    criteria.Code = code
    criteria.EffectiveAsOfDate = this.PolicyLine.getReferenceDateForCurrentJob(JurisdictionMappingUtil.getJurisdictionMappingForPolicyLocation(this.CPLocation.Location ))
