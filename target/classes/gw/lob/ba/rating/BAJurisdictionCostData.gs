...
class BAJurisdictionCostData extends BACostData<BAJurisdictionCost> {
  ...
  construct(effDate : Date, expDate : Date, c : Currency, ratedOrderArg : BARatedOrderType, jurisdiction : BAJurisdiction, costTypeArg : BAJurisdictionCostType, rateAmountTypeArg : RateAmountType, chargePatternArg : ChargePattern) {
    super(effDate, expDate, c, ratedOrderArg, jurisdiction, null)
    init(jurisdiction, costTypeArg, rateAmountTypeArg, chargePatternArg)
  }
  ...
  override function setSpecificFieldsOnCost(line : BusinessAutoLine, cost : BAJurisdictionCost) {
    ...
    cost.setFieldValue("BAJurisdictionCostType", _costType)
  }
