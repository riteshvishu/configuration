...
/**
 * Enhancement methods for {@link entity.BusinesVehicle}
 */
enhancement BusinessVehicleEnhancement : BusinessVehicle {
  ...
  */
  function updateStateValueForModifiers() {
    var state = JurisdictionMappingUtil.getJurisdictionMappingForPolicyLocation(this.Location)
  ...
  function validateVehicleClassCode() : String {
    ...
    var searchCriteria = new VehicleClassCodeSearchCriteria()
    var codes = Lookups.getVehicleClassCodes( searchCriteria, this.VehicleType, line.Fleet)
  ...
  function matches(candidate : BusinessVehicle) : boolean {
    ...
    return (thisKey.equals(candidateKey))
  }
  ...
  property get GaragingJurisdiction() : Jurisdiction {
    return JurisdictionMappingUtil.getJurisdictionMappingForPolicyLocation(this.Location)
  }
