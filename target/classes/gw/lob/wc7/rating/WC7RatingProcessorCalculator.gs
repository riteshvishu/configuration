...
@Export
class WC7RatingProcessorCalculator {
   ...
   * </ol>
   */
  private function calcRatingSubtotal(subtotal : RateSubtotalType, toGran : WC7RatingSubtotalGranularity, fromGran : WC7RatingSubtotalGranularity, st : Jurisdiction, store : Boolean) : BigDecimal {
