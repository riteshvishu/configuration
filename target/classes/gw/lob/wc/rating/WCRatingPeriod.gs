 ...
 */
  ...
  */
  function createCostData( step : WCRatingStepExt) : WCJurisdictionCostData {
    var cost = new WCJurisdictionCostData(RatingStart, RatingEnd, Jurisdiction.Branch.PreferredCoverageCurrency, Jurisdiction.FixedId, Jurisdiction.State, step)
