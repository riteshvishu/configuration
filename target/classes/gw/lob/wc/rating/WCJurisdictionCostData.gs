...
class WCJurisdictionCostData extends WCCostData<WCJurisdictionCost> {
  ...
  construct(effDate : Date, expDate : Date, c : Currency, jurisdictionID : Key, stateArg : Jurisdiction, stepArg : WCRatingStepExt) {
  ...
  override function getVersionedCosts(line : WorkersCompLine) : List<com.guidewire.commons.entity.effdate.EffDatedVersionList> {
