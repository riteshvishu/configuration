    ...
    static function initXformer() : com.guidewire.solr.batchload.xform.DigestTransformer {
      try {
          var xml =
            ...
            + " algorithm=\"SHA\""
            + " ignoreElems=\"urn, periodID, policyPublicID, sliceDate, periodStart, periodEnd, policyStart, policyEnd, periodIdWithSliceDate, jobType\"/>";
          var xf = new com.guidewire.solr.pc.batchload.xform.PCDigestTransformer()
