  ...
  override function doRestrictQuery(selectQueryBuilder : ISelectQueryBuilder) {
    ...
    if (_workPhone.NotBlank) {
      ...
      if (gwPhone != null) {
        ...
        throw new UserDisplayableException(PLDisplayKeys.Java_PhoneUtil_Error_ParseError, {_workPhone})
      }
    }
    if (_taxId.NotBlank) {
    ...
    if (_cityKanjiDenorm.NotBlank) {
      _cityKanjiDenormRestrictor.restrict(selectQueryBuilder, Contact#CityKanjiDenorm.PropertyInfo.Name, _cityKanjiDenorm)
    }
