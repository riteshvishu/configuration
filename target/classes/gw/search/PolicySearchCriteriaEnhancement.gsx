...
enhancement PolicySearchCriteriaEnhancement : entity.PolicySearchCriteria {
  ...
  //todo: deprecated this method in emerald
  //@Deprecated("In PC 7.0.4.  Use search() instead")
  ...
  */
  function meetsMinimumSearchCriteria() : boolean {
    ...
    if (this.CompanyNameKanji.NotBlank) return true

    if (this.FirstNameKanji.NotBlank || this.LastNameKanji.NotBlank) {
      return true;
    }
  ...
  //todo: deprecated this method in emerald
  //@Deprecated("In PC 7.0.4.  Use meetsMinimumSearchCriteria instead")
   ...
   */
  function getDateFieldsToSearchType() : List<DateFieldsToSearchType> {
  ...
  /**
   * Returns the appropriate PolicySeach LV mode to use in the UI.
   */
