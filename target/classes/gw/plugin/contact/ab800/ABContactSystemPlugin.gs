...
uses wsi.remote.gw.webservice.ab.ab800.abcontactapi.types.complex.AddressBookUIDContainer
uses wsi.remote.gw.webservice.ab.ab800.abcontactapi.types.complex.ABContactAPISearchCriteria
uses wsi.remote.gw.webservice.ab.ab800.abcontactapi.types.complex.ABContactAPISearchSpec
uses wsi.remote.gw.webservice.ab.ab800.abcontactapi.faults.AlreadyExecutedException
uses wsi.remote.gw.webservice.ab.ab800.abcontactapi.faults.EntityStateException
uses wsi.remote.gw.webservice.ab.ab800.abcontactapi.faults.RequiredFieldException
uses wsi.remote.gw.webservice.ab.ab800.abcontactapi.faults.SOAPException
uses wsi.remote.gw.webservice.ab.ab800.abcontactapi.faults.SOAPSenderException
uses wsi.remote.gw.webservice.ab.ab800.abcontactapi.faults.BadIdentifierException
uses wsi.remote.gw.webservice.ab.ab800.abcontactapi.faults.DataConversionException
uses wsi.remote.gw.webservice.ab.ab800.abcontactapi.faults.SOAPSenderException
...
class ABContactSystemPlugin implements ContactSystemPlugin {
  ...
  override function addContact(contact : Contact, payload : String,  transactionId : String) {
    ...
    try {
      ...
      var abXmlBackedInstance = wsi.remote.gw.webservice.ab.ab800.beanmodel.XmlBackedInstance.parse(payload)
  ...
  override function updateContact(contact : Contact, changes : String, transactionId : String) {
    ...
    try {
      ...
      var abXmlBackedInstance = wsi.remote.gw.webservice.ab.ab800.beanmodel.XmlBackedInstance.parse(changes)
      setTransactionId(transactionId)
  ...
  override function removeContact(contact : Contact, removeInfo : String, transactionId : String) {
    try {
      ...
      var abXmlBackedInstance = wsi.remote.gw.webservice.ab.ab800.beanmodel.XmlBackedInstance.parse(removeInfo)
      setTransactionId(transactionId)
  ...
  override function findDuplicates(contact : Contact) : DuplicateContactResultContainer {
    ...
    return new DuplicateContactResultContainerImpl(callWebService(\api -> {
      var abXmlBackedInstance = wsi.remote.gw.webservice.ab.ab800.beanmodel.XmlBackedInstance.parse(xml.bytes())
  ...
  private static function findBeanByRelativeNameAndPublicID(beans : Collection<KeyableBean>, relativeName : String, publicID : String) : KeyableBean {
    return beans.firstWhere(\ k -> (typeof k).RelativeName == relativeName 
  ...
  private function retrieveContactXML(addressBookUID : String) : XmlBackedInstance {
    var abContactXML : wsi.remote.gw.webservice.ab.ab800.beanmodel.XmlBackedInstance
    try {
