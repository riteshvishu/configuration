...
uses soap.BCBillingSystemAPI.entity.ChargeInfo
...
class ChargeInfoUtil
{
  ...
  */
  static function getChargeInfos(period : entity.PolicyPeriod) : soap.BCBillingSystemAPI.entity.ChargeInfo[] {
    return getChargeOrWrittenInfos(period, true)
  }
  
  static function getInstallmentInfos(period : entity.PolicyPeriod) : soap.BCBillingSystemAPI.entity.ChargeInfo[] {
    return getChargeOrWrittenInfos(period, false)
  }
  
  private static function getChargeOrWrittenInfos(period : entity.PolicyPeriod, useCharged : boolean) : soap.BCBillingSystemAPI.entity.ChargeInfo[]{
    ...
    for(txn in chargedTransactions){
      ...
      if(chargesMap.containsKey( key ))
      {
        ...
        var charge = new soap.BCBillingSystemAPI.entity.ChargeInfo();
