...
class DiffHelper <L extends entity.PolicyLine> extends DiffHelperBase {
 ...
 final function addScheduledItemClauses(helper : AbstractScheduleHelper, diffItems : List<DiffItem>) : List<DiffItem> {
    var scheduleItemsLine1 = helper.getScheduledItemsForPolicyLine(Line1).where(\ item -> item.ScheduleParent.ScheduledItemPattern != null)
    var scheduleItemsLine2 = helper.getScheduledItemsForPolicyLine(Line2).where(\ item -> item.ScheduleParent.ScheduledItemPattern != null)
