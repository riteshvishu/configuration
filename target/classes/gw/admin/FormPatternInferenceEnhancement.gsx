...
enhancement FormPatternInferenceEnhancement : entity.FormPattern {
  ...
  property get SelectedCovTermType() : String {
    return (this.SelectedCovTerm as Object).Class.SimpleName
  }
  ...
  property get ClausePattern() : ClausePattern {
    return PCDependencies.getProductModel().getPattern(this.ClausePatternCode, gw.api.productmodel.ClausePattern)
  }
   ...
   */
  function filteredSearchResults(searchCriteria : gw.api.productmodel.CoveragePatternSearchCriteria) : ClausePattern[] {
    return searchCriteria.performClausePatternSearch(this.PolicyLinePatternRef.Pattern)
  }
