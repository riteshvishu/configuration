...
enhancement ContactEnhancement : entity.Contact {
  ...
  public function mergeAddresses(survivingAddress : Address, mergedAddress : Address) {
    ...
    if (mergedAddress.equals(survivingAddress)) {
    ...
    if (mergedAddress.equals(this.PrimaryAddress)) {
    ...
    if (survivorContactAddress == null and not survivingAddress.equals(this.PrimaryAddress)) {
  ...
  property get AccountName() : String {
    if (this typeis Person) {
      ...
      if (this.FirstName != null) {
        sbuf.append(this.FirstName)
      }
      if (this.LastName != null) {
        if (!sbuf.toString().Empty and !this.LastName.Empty) {
          sbuf.append(" ")
        }
        sbuf.append(this.LastName)
      }
