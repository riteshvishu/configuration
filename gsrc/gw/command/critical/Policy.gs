...
class Policy extends BaseCommand {
  ...
  function draftPeriod(policyLine : String) : PolicyPeriod {
    ...
    switch(policyLine == null ? "wc": policyLine.toLowerCase()){
      case "wc7": period = SamplePolicyGenerator.wWC7Line()
        break  
      case "wc7retro": period = SamplePolicyGenerator.wWC7Retro()
        break     
      case "wc7allstates" : period = SamplePolicyGenerator.wWC7InAllTestStates()
        break;
