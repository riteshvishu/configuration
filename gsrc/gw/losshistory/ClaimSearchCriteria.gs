...
class ClaimSearchCriteria implements IClaimSearchCriteria, Serializable {
  ...
  override function performSearch() : ClaimSet {
    try {
      ...
      throw new UserDisplayableException(displaykey.Java.Policy.Claims.NoPluginConfigured, e)
    }  catch(e: RemoteLoginException  ) {
      throw new UserDisplayableException(displaykey.Java.Policy.Claims.RemoteLoginFailed, e)
      ...
      if (cause typeis  PluginException){
        ...
        throw new UserDisplayableException(displaykey.Java.Policy.Claims.NoConnection, e)
      }
