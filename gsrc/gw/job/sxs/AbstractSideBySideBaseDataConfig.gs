    ...
    override function init() : Map<IType,Set<String>> {
      var superTypeToPropertiesMap : Map<IEntityType,Set<String>> = {
        ...
        PolicyPeriod -> {"RIRiskVersionLists", "QuoteHidden", "EditLocked", "DepositCollected", "InvoiceStreamCode", "NewInvoiceStream",
                         ...
                         "BillImmediatelyPercentage", "DepositOverridePct", "DepositAmount", "WaiveDepositChange", "PaymentPlanID", "PaymentPlanName",
                         "AltBillingAccountNumber", "AllocationOfRemainder", "RefundCalcMethod", "BillingMethod", "MinimumPremium", "PaymentPlans",
