...
class NameLocaleSettings {
  ...
  private static final var validTextFormatModes : Set<String> = { "default", "Japan", "", null }
  ...
  public static final var DEFAULT_DISPLAY_NAME_FIELDS : Set<NameOwnerFieldId> = {
    field.FIRSTNAME, field.PARTICLE, field.LASTNAME, field.SUFFIX
      }.freeze()
