...
class ImpactTestingSearchCriteriaImportExport {
  ...
  // XML TOKEN NAMES
  static var SEARCH_CRITERIA_NAME : String = "ImpactTestingSearchCriteria"
  static var CHILD_ELEMENT_NAME : String = "ArrayElement"
  ...
  var productArrayPropFunc : block(n : XMLNode, sc : ImpactTestingSearchCriteria) =
    \ n, sc -> {
      ...
      n.Children.each(\ c -> {
        var prod = Product.getByCode(c.Text)
