...
enhancement RateTableMatchOpEnhancement : RateTableMatchOp {
  ...
  function hasSameNameAs(inputParam : RateQueryParam) : boolean {
    return this.Name.equals(inputParam.Name)
  }

  function getPhysicalColumnNameFor(columnName : String) : String {
    var v = this.Params.firstWhere(\ p -> p.ColumnName.equals(columnName))
    if (v == null)
  ...
  function newInstance<R extends Comparable>(inputParam : RateQueryParam<R>) : MatchOperation {
    return this.MatchOpDefinition.matchOperation(this, inputParam)
  }
  ...
  property get LineOfBusiness() : gw.api.productmodel.PolicyLinePattern {
    ...
    return gw.api.productmodel.PolicyLinePattern.getByCode(lob)
  }
