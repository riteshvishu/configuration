...
enhancement CostEnhancement : Cost {
  ...
  property get CurrencyChanged() : boolean {
    var period = this.BranchUntyped as PolicyPeriod
    return this.SettlementCurrency != period.PreferredSettlementCurrency or this.CoverageCurrency != period.PreferredCoverageCurrency
  }
}
