...
/**
 * This delegate is used as an AddressFillableExtension adapter to a PolicyAddress entity.
 */
@Export
class PolicyAddressDelegate implements AddressFillableExtension {

  private var _policyAddress: PolicyAddress
