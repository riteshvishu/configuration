...
class CPPolicyLineMethods extends AbstractPolicyLineMethodsImpl {
  ...
  override property get CoveredStates() : Jurisdiction[] {
    ...
    for (loc in _line.CPLocations) {
      covStates.add(JurisdictionMappingUtil.getJurisdictionMappingForPolicyLocation(loc.Location ))
    }
  ...
  override property get AllCoverages() : Coverage[] {
    ...
    var coverages : List<Coverage> = locations*.Buildings*.Coverages.toList()
  ...
  override property get AllCoverables() : Coverable[] {
    ...
    var coverables : List<Coverable> = locations*.Buildings.toList()
    ...
    locations.each(\location -> {
      ...
      buildings.each(\building -> {
        ...
        buildingCosts.each(\cost -> {
          ...
          while (costWithWorksheet.CPRatingWorksheet == null and costWithWorksheet.BasedOn != null) {
