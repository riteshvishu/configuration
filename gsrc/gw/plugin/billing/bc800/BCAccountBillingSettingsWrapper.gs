...
uses wsi.remote.gw.webservice.bc.bc800.billingsummaryapi.enums.PaymentMethod
...
class BCAccountBillingSettingsWrapper implements BillingPaymentInfo{
  ...
  override property set PaymentMethod(value : AccountPaymentMethod) {
    _soapObject.PaymentInstrumentRecord.PaymentMethod = wsi.remote.gw.webservice.bc.bc800.billingsummaryapi.enums.PaymentMethod.valueOf(value.Code)
  }
