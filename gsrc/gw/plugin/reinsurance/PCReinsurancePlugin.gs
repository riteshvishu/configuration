...
class PCReinsurancePlugin implements IReinsurancePlugin {
 ...
 /**
   * Attach the reinsurable risk to the applicable reinsurance agreements and return
   * the associated RIRIsk
   *
   * @param risk the reinsurable risk
   */
 ...
 /**
   * Recompute the program-related information associated with the given reinsurable.
   * This is normally used in situations where the reinsurance programs could have changed.
   *
   * @param risk The reinsurable that needs its attachments refreshed.
   */
  ...
  /**
   * Remove the RIRisk associated with a given reinsurable risk.
   */
  ...
  /**
   * When this branch is a renewal and a change to remove one or more Reinsurables is applied to this branch,
   * the list of Reinsurables will not contain the removed ones, but the cloned branch could contain implementation
   * data related to these removed Reinsurables.   This method is called to allow the RI system to clean up.
   *
  ...
  /**
   * Bind all the draft RIVersionLists associated with a branch. This is usually being
   * called on binding a policy period.
   *
   * @param policyPeriod the policy period
   */
  ...
  /**
   * Withdraw all RIVersionLists associated with a branch. This is usually being
   * called on withdrawing a policy period.
   *
   * @param policyPeriod the policy period
   */
  ...
  /**
   * Check to see if a contact is not being used by reinsurance
   */
  ...
  public override function findReinsuranceRiskInfo(risks : Reinsurable[], riCovGroup : RICoverageGroupType, date : Date) : IRIRiskInfo {
