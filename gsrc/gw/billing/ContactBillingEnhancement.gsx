...
uses com.guidewire.pl.system.integration.messaging.MessageStatus
...
enhancement ContactBillingEnhancement : entity.Contact {
  ...
  function retryBillingEventMessages(){
    ...
    var iterator = messageQuery.select().iterator()
    while(iterator.hasNext()){
      var blockedMessage = iterator.next()
  ...
  /**
   * Return true id this contact is associated with an producer.
   */
