...
class ProducerAPI {
  ...
  function removeProducerCodeFromExistingAgency(producerCodeID : String, agencyID : String) : boolean {
    ...
    var prodCode = bundle.loadByPublicId(ProducerCode, producerCodeID) as ProducerCode
  ...
  function moveProducerCodeToExistingBranch(producerCodeID : String, toBranchID : String) : boolean {
    ...
    if (fromBranch != null and fromBranch.PublicID.equals(toBranchID)) {
      return false
    }

    // load toBranch
    var toBranch = bundle.loadByPublicId(Group, toBranchID) as Group
