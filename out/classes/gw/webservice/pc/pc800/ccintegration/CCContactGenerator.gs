...
class CCContactGenerator {
  ...
  public function getOrCreateContact( pcContact : entity.Contact ) : XmlElement {
    ...
    if (pcContact typeis entity.Person && ccContact typeis CCPerson) {
      ...
      ccContact.CellPhoneCountry = pcContact.CellPhoneCountry;
    ...
    if (ccContact != null) {
      ccContact.WorkPhoneCountry = pcContact.WorkPhoneCountry
      ...
      ccContact.FaxPhoneCountry = pcContact.FaxPhoneCountry
      ccContact.FaxPhone = pcContact.FaxPhone
      ccContact.FaxPhoneExtension = pcContact.FaxPhoneExtension
      ccContact.HomePhoneCountry = pcContact.HomePhoneCountry
  ...
  protected function findExistingAddressOrAddToList(key:Key, addressToFind : CCAddress ) : XmlElement {
    for(  o in _gen.getMappedPCObjects().Values ) {
      if( o typeis Envelope_CCAddress ) {
        if( o.AddressBookUID == addressToFind.AddressBookUID and
            o.AddressLine1 == addressToFind.AddressLine1 and
            o.AddressLine2 == addressToFind.AddressLine2 and
            o.AddressLine3 == addressToFind.AddressLine3 and
            o.City == addressToFind.City and
            (o.County==null or addressToFind.County==null or o.County==addressToFind.County) and
            o.PostalCode == addressToFind.PostalCode and
            o.State == addressToFind.State and
            (o.Country==null or addressToFind.Country==null or o.Country==addressToFind.Country)) {
          return o
        }
      }
    }
