...
uses gw.policylocation.PolicyLocationAddressDelegate
...
class JurisdictionMappingUtil {
  ...
  public static function getJurisdiction(policyLocation : PolicyLocation) : Jurisdiction {
    ...
    return (AddressJurisdictionHandler.getJurisdiction(new PolicyLocationAddressDelegate(policyLocation)))
  }
