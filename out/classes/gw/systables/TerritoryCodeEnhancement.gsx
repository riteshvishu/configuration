...
enhancement TerritoryCodeEnhancement : TerritoryCode {
  ...
  function createSearchCriteria(): TerritoryLookupCriteria {
    ...
    criteria.State = JurisdictionMappingUtil.getJurisdictionMappingForPolicyLocation(this.PolicyLocation)
  ...
  property get MatchingCriteriaMap() : Map<String, Object> {
    var juris = JurisdictionMappingUtil.getJurisdictionMappingForPolicyLocation(this.PolicyLocation)
    return {
      "Code" -> this.Code,
      "State" -> juris,
