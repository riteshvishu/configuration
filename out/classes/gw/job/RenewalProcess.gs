...
class RenewalProcess extends NewTermProcess {
  ...
  function raiseIssueForNotificationDateSet() {
    JobProcessLogger.logInfo("Renewal couldn't be withdrawn because notification date set, raising UW Issue instead: " + _branch)
  }
  ...
  protected function unconditionalIssueRenewal() {
    ...
    TransactionUtil.runAtomically(\ -> {
       ...
       */
      _branch.promoteBranch(false) // commit...
